import { createAchievementPageData, getAchievementPageData } from '../../services/achievement'
...
Page({
  ...
  onShow(this: AchievementPageInstance) {
    if (this.data.earned.length || this.data.locked.length || this.data.errorMessage) {
      void this.loadPageData()
    }
  },
